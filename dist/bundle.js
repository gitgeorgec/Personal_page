...
$('body').on('mousemove', function (e) {
  ...
  $('#MyPhoto').css("transform", "skewX(".concat((e.clientX - canvas.width / 2) / 50, "deg) skewY(").concat((e.clientX - canvas.height / 2) / 50, "deg"));
...
module.exports = {
  ...
  experience2Title: "T.Y.LIN 美商同棪國際工程顧問股份公司 台灣分公司 擔任結構工程師.",
  experience2Content: "T.Y.LIN 美商同棪國際工程顧問股份公司 台灣分公司 擔任結構工程師",
  experience3: "2018 年 3 月 - 至今",
  experience3Title: "自學前端技術",
  experience3Content: "自學前端技術",
  skillTitle: "技能",
  skill1Title: "前端技能",
  skill2Title: "後端技能",
  skill3Title: "語言"
